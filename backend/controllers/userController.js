...
exports.loginUser = catchAsyncErrors(async (req, res, next) => {
     ...
     //Check point: your have given Email & Password?
...
exports.forgotPassword = catchAsyncErrors(async (req, res, next) => {
     ...
     try {
          await sendEmail({
               email: user.email,
               subject: `Codedrishti.com Password Recovery`,
               message,
          });
...
exports.resetPassword = catchAsyncErrors(async (req, res, next) => {
     ...
     if (!user) {
          return next(new ErrorHandler("Reset password token is invailid or has been expired.", 400));
     }
